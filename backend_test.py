#!/usr/bin/env python3
"""
Backend API Testing for DK Interiors Contact Form
...
BASE_URL = "https://interiordesign-dk.preview.emergentagent.com"
...
def run_all_tests():
    ...
    print("🚀 Starting DK Interiors Contact API Backend Tests")
